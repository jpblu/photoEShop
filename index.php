...
<div id="page" class="hfeed">
	...
	<article id="post-873" class="post-873 post type-post status-publish format-standard">
		<header class="entry-header">
				...
				<p>
					Seleziona la galleria da visitare.
					...
					<?php
						$galleryindex = CoreSystem::getGalleries(0);
						foreach($galleryindex as $key => $value) 
						{
							echo "<tr>\n";
							echo "<td style='vertical-align: middle;'><b>".$galleryindex[$key]['description']."</td>"
								  ."<td style='vertical-align: middle;'>".$galleryindex[$key]['time']."</b></td>"
								  ."<td style='vertical-align: middle;'>"
								  ." <a href='gallery.php?id=".$galleryindex[$key]['id']."'>"
								  ."  <img src='imgsys/gallery.png' width='40' title='Visualizza la Galleria'>"
								  ." </a>"
								  ."</td>\n";
							echo "</tr>\n";
						}
						
						$eventindex = CoreSystem::getEvents();
						foreach($eventindex as $key => $value) 
						{
							echo "<tr>\n";
							echo "<td style='vertical-align: middle;'><b>".$eventindex[$key]['title']."</td>"
								."<td style='vertical-align: middle;'>".$eventindex[$key]['time']."</td>"
								."<td style='vertical-align: middle;'>"
								//." <a href='event.php?id=".$eventindex[$key]['id']."'>"
								."  <img class='eventsLink' link='event.php?id=".$eventindex[$key]['id']."' wh='".encrypt_decrypt("encrypt", $eventindex[$key]['notes'])."' src='imgsys/kdict.png' width='40' title='Visualizza Evento' style='cursor:pointer'>"
								//." </a>"
								."</td>\n";
							echo "</tr>\n";
						}
	...
	<footer id="colophon" role="contentinfo">
			...
			<div id="site-generator">
				<a href="http://wordpress.org/" title="Piattaforma semantica di editoria personale " rel="generator">&copy; Copyright 2016 Andreafusco.net  &bull; All Rights Reserved  &bull;</a>
			</div>
	</footer><!-- #colophon -->
</div><!-- #page -->

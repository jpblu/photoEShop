...
<div id="page" class="hfeed">
					...
					<nav id="navigation" class="clearfix">	
						<div class="menu left">
							<ul id="menu" class="clearfix">
								...
								<li id="menu-item-2677" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2615"><a href="http://www.andreacantini.photos/eshop/">Eshop</a></li>
	...
	<article id="post-873" class="post-873 post type-post status-publish format-standard">
		<header class="entry-header">
				...
				<div class="entry-content" style="min-height: 250px;">
				<p>
				Le foto che trovate sull'eshop posso essere acquistate in formato digitale (Digitale HD) o cartaceo nei seguenti formati :
				</p>
				<p align="center">
				Digitale HD: 5€ (4,00€ scontato)<br>
				10x15 - 3,50€        (3,00€ scontato)<br>
				12x18 - 4,00€        (3,50€ scontato)<br>
				15x23 - 5,00€        (4,00€ scontato)<br>
				20x30 - 6,00€        (5,00€ scontato)<br>
				30x45 - 10,00€      (9,00€ scontato)
				</p>
				<p>
				Per ogni ordine ci sarà da aggiungere <b>il costo fisso di 2€ per la gestione</b> indipendentemente dal numero di foto ordinate.<br>
				Sull'eshop le foto sono caricate a bassa risoluzione (appaiono poco definite e sgranate) per agevolare il caricamento delle pagine.<br>
				<b>Le foto che verranno stampate e vendute saranno ad alta risoluzione e prive dei loghi sovraimpressi.</b><br>
				<br>
				I metodi di pagamento consentiti sono <b>Bonifico Bancario, Carta di Credito e Paypal.</b>
				</p>
				<p>Per informazioni, assistenza e aiuto nell'utilizzo dell'Eshop scrivete a <a href="mailto:info@andreacantini.info">info@andreacantini.info</a>.</p>
				...
				<?
					if (isset($_SESSION['eshop_order']) && count($_SESSION['eshop_order']) > 0) {
						...
						foreach($_SESSION['eshop_order'] as $key => $value) {
							...
							echo "<td><a href='#' class='del_chart' data-userid=".$_SESSION['eshop_order'][$key]['id']."><img src=\"imgsys/cross.png\" title='Elimina' alt='Elimina'></a></td>";
							echo "</tr>\n";
